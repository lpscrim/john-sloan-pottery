      ...
      <div className=" mx-auto w-full">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-32 lg:gap-48 lg:mb-32 xl:gap-80">
          ...
          <div className="space-y-8 lg:col-start-3 lg:col-span-2 text-lg">
            {status === 'sent' ? (
              <p className="text-muted-foreground text-sm">Message sent — I&apos;ll be in touch.</p>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <input
                    ...
                    className="bg-transparent border-b border-foreground/20 focus:border-foreground/60 outline-none py-2 text-sm placeholder:text-muted-foreground transition-colors w-full"
                  />
                  <input
                    type="email"
                    placeholder="Email"
                ...
                <textarea
                  ...
                  className="bg-transparent border-b border-foreground/20 focus:border-foreground/60 outline-none py-2 text-sm placeholder:text-muted-foreground transition-colors w-full resize-none"
                />
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="ml-auto text-sm text-muted-foreground hover:text-foreground transition-colors disabled:opacity-50 cursor-crosshair"
                  >
