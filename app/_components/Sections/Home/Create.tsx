  ...
  return (
    <section id="create" className="">
      ...
      <div className="flex w-full h-[80svh] relative overflow-hidden justify-center items-center">
        ...
        <div className="absolute sm:right-16 w-full sm:w-1/2 flex -mt-28 sm:flex-end font-medium justify-center tracking-wide z-20 flex-col">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl text-background text-center sm:text-right tracking-tight mt-12 nav">Each piece is unique</h2>
