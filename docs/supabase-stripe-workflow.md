...
- Platform retains 1% as `application_fee_amount`
...
6. Creates PI as a direct charge on the connected account with 1% `application_fee_amount`
...
- Financial table: Subtotal / Shipping / Total / Platform fee (1%) / Stripe fee (or "See dashboard") / Net to you
